...
4. **v0.4 planning kickoff** (next Claude session — session 8). Use the Next Session Prompt block below ("Start v0.4 planning — jOneFlow. v0.3 released 2026-04-22 …"); the 6-item v0.4 backlog is already seeded.
...
4. **v0.4 planning kickoff** (다음 Claude 세션 — 세션 8). 아래 다음 세션 시작 프롬프트 블록 사용 ("Start v0.4 planning — jOneFlow. v0.3 released 2026-04-22 …"); 6 항목 v0.4 백로그는 이미 seed.
