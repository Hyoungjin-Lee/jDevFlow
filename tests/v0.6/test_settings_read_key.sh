...
run_with_settings() {
    ...
    JDEVFLOW_ROOT="$JDEVFLOW_ROOT_OLD"
    export JDEVFLOW_ROOT
}
...
got=$( ( JDEVFLOW_ROOT="$ROOT_A"; export JDEVFLOW_ROOT; . "$LIB"; settings_read_key schema_version ) )
assert_eq 'simple read schema_version' '0.4' "$got"

got=$( ( JDEVFLOW_ROOT="$ROOT_A"; export JDEVFLOW_ROOT; . "$LIB"; settings_read_key workflow_mode ) )
assert_eq 'simple read workflow_mode' 'desktop-cli' "$got"

got=$( ( JDEVFLOW_ROOT="$ROOT_A"; export JDEVFLOW_ROOT; . "$LIB"; settings_read_stage_assign stage9_review ) )
assert_eq 'stage_assign stage9_review' 'codex' "$got"

# ---- Case 2: missing key returns empty ----
got=$( ( JDEVFLOW_ROOT="$ROOT_A"; export JDEVFLOW_ROOT; . "$LIB"; settings_read_key missing_key ) )
assert_eq 'missing key returns empty' '' "$got"

got=$( ( JDEVFLOW_ROOT="$ROOT_A"; export JDEVFLOW_ROOT; . "$LIB"; settings_read_stage_assign stageX_missing ) )
...
EOF
got=$( ( JDEVFLOW_ROOT="$ROOT_B"; export JDEVFLOW_ROOT; . "$LIB"; settings_read_key team_mode ) )
assert_eq 'empty value reads as empty' '' "$got"

got=$( ( JDEVFLOW_ROOT="$ROOT_B"; export JDEVFLOW_ROOT; . "$LIB"; settings_read_stage_assign stage8_impl ) )
...
EOF
got=$( ( JDEVFLOW_ROOT="$ROOT_C"; export JDEVFLOW_ROOT; . "$LIB"; settings_read_key team_mode ) )
...
EOF
got=$( ( JDEVFLOW_ROOT="$ROOT_D"; export JDEVFLOW_ROOT; . "$LIB"; settings_read_key _note ) )
...
got=$( ( JDEVFLOW_ROOT="$ROOT_E"; export JDEVFLOW_ROOT; . "$LIB"; settings_read_key team_mode ) )
