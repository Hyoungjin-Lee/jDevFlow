...
name: tool-picker
description: >-
  jOneFlow advisory for stage, mode, risk_level, and next step decisions.
  Match when a user enters a new stage, asks what next or which tool to open,
  or mentions jOneFlow with stage/mode/risk_level context. Read HANDOFF.md and
  reply with a ranked advisory only.
---

## 1. Purpose & scope

- This skill gives a one-screen advisory for the current jOneFlow moment.
...
- Docs that do NOT carry frontmatter: `docs/01_brainstorm/**`, `docs/02_planning/**`, `docs/notes/dev_history.md`, `HANDOFF.md`, `CLAUDE.md`, any `README.md`.
...
- Context trigger: the user mentions jOneFlow with `stage`, `mode`, or
  `risk_level` language.
