...
├── WORKFLOW.md             ← (archived) 13-stage legacy — docs/operating_manual.md Sec.5 참조
...
전체 모델(stage type, 실행 조건, 완료 기준, 재진입 규칙)은 [`docs/operating_manual.md`](./docs/operating_manual.md) Sec.5 참조.
