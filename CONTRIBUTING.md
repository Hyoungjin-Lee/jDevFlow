# Contributing to jDevFlow

## 1. Purpose & audience

This file is the single contributor-facing reference for jDevFlow v0.3. Use it
...
jDevFlow uses bundle-aware design folders. Bundle folders follow the D4.x3
...
jDevFlow v0.3 does not auto-migrate older handoff files.
