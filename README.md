...
**jOneFlow** is the app/software development workflow template in the [Jonelab_Platform](https://github.com/aigeenya/Jonelab_Platform) family. Other flows (jDocsFlow, jCutFlow, …) are planned for different domains.
