...
| AC.B1.6 | PASS | Verbatim D4.x2/D4.x3/D4.x4 quote block present and sourced to `docs/notes/decisions.md` + Bundle 4 design Sec. 0. |
...
| AC.B1.8 | PASS | `docs/notes/tool_picker_usage.md` + `.ko.md` exist as the D1.x reference pair, both 46 lines, both carrying the full D4.x2 frontmatter (`stage: 5-support`, `bundle: 1`). |
