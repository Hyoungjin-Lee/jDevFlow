---
title: 최종 검증 — jOneFlow v0.3 (Validation Group 1)
stage: 11
bundle: 1+4
version: 1
language: ko
...
# 최종 검증 — jOneFlow v0.3 (Validation Group 1)
...
jOneFlow v0.3 (Bundle 1 + 4) 구현은 QA 및 릴리스 승인. Stage 12 진입 가능. Stage 13 은 M.6 에 따라 단일 공동 `v0.3` git tag 로 릴리스.
