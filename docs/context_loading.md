...
| 파일 | 임계값 | 현재 | 정책 |
|------|--------|------|------|
| `CLAUDE.md` | ≤ 85줄 | ~85줄 | 프로젝트 절대 규칙만 |
| `docs/operating_manual.md` | ≤ 1000줄 | ~362줄 | 6개 섹션 자기-완결 |
| `docs/bridge_protocol.md` | ≤ 400줄 | ~340줄 | 회의창 영구 지침 + 사고 사례 |
| `docs/context_loading.md` | ≤ 200줄 | ~200줄 | 본 파일 (로드 가이드) |
